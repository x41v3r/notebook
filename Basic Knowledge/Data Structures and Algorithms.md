...
* How to informationize real world problems with program code?
...
* **High efficiency and low storage requirements**: It takes less time to run and does not consume memory.
...
* The data type of each data element in a linear list is the same, that is to say, the storage spaces occupied by each element are the same.
